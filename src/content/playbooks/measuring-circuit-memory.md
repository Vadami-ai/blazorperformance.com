...
dominates noise. **Hold** the sessions connected and lightly active for 15–30
...
- `ComponentState` / `RenderTreeBuilder` frames retaining large object graphs —
  a component is holding full datasets in fields instead of paging/virtualizing
...
| 0.3–1.5 MB | Typical enterprise range — model it and move on |
| 1.5–3 MB | Sizing works but state design deserves a look (virtualization, paging, cache scoping) |
